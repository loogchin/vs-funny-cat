...
class Character extends FlxSprite
{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				case 'kauan':
					...
					animation.addByPrefix('singRIGHT', 'Sing Left', 24);
					animation.addByPrefix('singDOWN', 'Sing Down', 24);
					animation.addByPrefix('singLEFT', 'Sing Right', 24);
	
					loadOffsetFile(curCharacter);
	
					playAnim('idle');
				case 'kauannight':
					tex = Paths.getSparrowAtlas('kauannight','shared',true);
					frames = tex;
					animation.addByPrefix('idle', 'Idle', 24);
					animation.addByPrefix('singUP', 'Sing Up', 24);
					animation.addByPrefix('singRIGHT', 'Sing Left', 24);
			...
			case 'bf-car':
				...
				flipX = true;
				case 'bfnight':
					var tex = Paths.getSparrowAtlas('boyfriendnight','shared',true);
					frames = tex;
					animation.addByPrefix('idle', 'BF idle dance', 24, false);
					animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
					animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
	...
	public function dance(forced:Bool = false)
	{
		if (!debugMode)
		{
			switch (curCharacter)
			{
				case 'gf' | 'gf-christmas' | 'gf-car' | 'gf-pixel'|'gfnight':
